...
$sweetAlertConfig = "";
  ...
  if(isset($_POST['login'])) {
    ...
    // Validate the inputs
    $user = $con->loginUser($id, $password);

    // If the user is found, set session variables and show success message
    if ($user) {
      $_SESSION['adminID'] = $user['UA_ID'];
      $_SESSION['adminFN'] = $user['UAFirstName'];
      $_SESSION['adminLN'] = $user['UALastName'];
      $_SESSION['adminRole'] = $user['UARole'];
    ...
    <div class="glass-card text-center">
      ...
      <form method="POST" action="">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <a href="fpasswordAdmin.php" class="link-btn">Forgot password?</a>
        </div>
