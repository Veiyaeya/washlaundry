...
class database{
    ...
    // Function to get all Full Service & Drop-Off Service (services.php)
    ...
    // Function to get all Self Service Services (services.php)
    ...
    // Function to get service by ID (editService.php)
    ...
    // Function to update Service data (editService.php)
    ...
    // Function to delete Service data (deleteService.php)
