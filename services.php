    ...
    <div class="modal-dialog">
      <form class="modal-content" id="courseForm" method="POST" action="">
        ...
        <div class="modal-footer">
          <button type="submit" id="fService_button" name="fAdd_service" class="btn btn-success">Add Service</button>
        </div>
  ...
  <div class="modal fade" id="addSelfServiceModal" tabindex="-1">
    <div class="modal-dialog">
      <form class="modal-content" id="selfServiceForm" method="POST" action="">
        ...
        <div class="modal-footer">
          <button type="submit" id="sService_button" name="sAdd_service" class="btn btn-success">Add Service</button>
        </div>
