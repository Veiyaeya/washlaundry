...
if (!isset($_SESSION['adminID']) || isset($_SESSION['CustomerID'])) {
  ...
  // If logged in, redirect to the appropriate home page
  if (isset($_SESSION['adminID'])) {
    ...
    // If a customer is logged in, set Customer Name
...
if (isset($_POST['resetPassword'])) {
  ...
  if ($_POST['newPassword'] === $_POST['confirmPassword']) {
    ...
    $result = $con->changeCustomerPass($userId, $newPasswordHashed);
...
<html lang="en">
  ...
  <body>
    ...
    <div class="glass-card text-center">
      ...
      <form method="POST" action="fpassword.php" class="mt-4">
        ...
        <div class="text-center mt-3">
          Remember your password? <a href="login.php" class="link-btn" style="text-decoration: underline;">Login</a>
        </div>
      </form>
    </div>
